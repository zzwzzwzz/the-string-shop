...
Class creatAlipayItemURL
	...
	Public Function creatAlipayItemURL(t1,t4,t5,service,agent,partner,sign_type,subject,body,out_trade_no,price,discount,show_url,quantity,payment_type,logistics_type,logistics_fee,logistics_payment,logistics_type_1,logistics_fee_1,logistics_payment_1,seller_email,notify_url,key)
		Dim itemURL
...
For j = 0 To Count Step 1
  ...
  Next
	...
	Public Function get_AlipayButtonURL(itemURL,imgtitle,imgsrc)
		dim responseText1
		responseText1	=	responseText1 & "<center><font color=red><b>点击下面的支付宝交易按钮进行在线支付</b></font><br><a href='" & itemURL & "' target='_blank'>"		'购买网址
		responseText1	=	responseText1 & "<img alt='" & imgtitle & "' src='"				'图片说明
		responseText1	=	responseText1 & imgsrc											'图片地址
		responseText1	=	responseText1 & "' align='absmiddle' border='0'/></a></center>"
