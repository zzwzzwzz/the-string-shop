...
response.write  "<div class=brclass></div>"&_
				...
				"		<td align=center>"
						...
						rs.close
						set rs=nothing
						if root_info_address<>""  then response.write "联系地址："&root_info_address
    					if root_info_zip<>""      then response.write "&nbsp; 邮编："&root_info_zip&"<br>"
    					if root_info_tel<>""      then response.write "联系电话："&root_info_tel
    					if root_info_email<>""    then response.write "&nbsp; E-mail："&root_info_email&"<br>"
response.write  "		Copyright &copy; "&year(now())&root_info_SiteName&" &nbsp; 版权所有  "&_
    			"		</td>"&_
				"	</tr>"&_
				"	<tr></tr>"&_
				"</table>"&_
