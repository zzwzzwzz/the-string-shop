...
<tbody class="altbg2">
	...
	<tr>
		...
		<table border="1" width="100%" id="table5" cellpadding="4" style="border-collapse: collapse" bordercolor="#CCCCCC">
			<tr>
				<td bgcolor="#EFEFEF"><b><font color="#FF6600">序号</font></b></td>
				<td bgcolor="#EFEFEF"><b><font color="#FF6600">备选项</font></b></td>
				<td bgcolor="#EFEFEF"><b><font color="#FF6600">修改保存</font></b></td>
				<td bgcolor="#EFEFEF"><b><font color="#FF6600">删除</font></b></td>
			</tr>
			<%
...
<input type="hidden" name="action" value="vote_addsave">
    <tr>
		<td colspan="2" bgcolor="#EFEFEF" class="header">备选项-添加</td>
	</tr>
	<tr>
		<td>备选项：</td>
