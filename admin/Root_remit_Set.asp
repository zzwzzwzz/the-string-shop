...
sub save()
    root_info_remit =my_request("content",0)
     
    ErrMsg=""
    if root_info_remit="" then
    	FoundErr=True
    ...
    if FoundErr<>True then
        ...
        rs("root_info_remit") =root_info_remit
        rs.update
        rs.close
        set rs=nothing
        call ok("您已成功保存[关于我们]设置！","root_remit_set.asp")
    else
...
<tbody class="altbg2">
<form name="form1" action="Root_remit_Set.asp" method="post">
<input type="hidden" name="action" value="save"> 
	<tr>
		<td class="header" colspan="2">汇款说明- 设置</td>
	</tr>
	<tr>
		<td colspan="2">
		<p align="center"><font color="#808080">
		(在此填写银行汇款账户及邮局汇款账户信息,汇款说明将会在前台客户下单选择非在线支付方式付款时显示出来)</font></td>
	</tr>
	...
	<tr>
		...
		<td>
            ...
            <script language="javascript">
                document.write ('<iframe src="Root_remit_TxtBox.asp" id="message" width="95%" height="400"></iframe>')
